...
// Errors
$lang['auth_incorrect_password'] = '<div class="alert alert-danger" style="margin: 10px 0">Неправильний пароль</div>';
$lang['auth_incorrect_login'] = '<div class="alert alert-danger" style="margin: 10px 0">Неправильний логін</div>';
$lang['auth_incorrect_email_or_username'] = '<div class="alert alert-danger" style="margin: 10px 0">Login or email doesn\'t exist</div>';
